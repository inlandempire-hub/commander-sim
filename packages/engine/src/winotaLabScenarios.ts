...
export const WINOTA_LAB_SCENARIOS: LabScenario[] = [
  {
    ...
    setup:
      "Winota in the command zone, with a non-Human and a Human already out to attack with, and Humans waiting on top of your library for her to find.",
    ...
    checks: [
      "Cast Winota from the command zone for {2}{R}{W}. She arrives as a 4/4 Human Warrior.",
      ...
      "Take Myrel: she arrives tapped and attacking, already in the combat, without being cast and without paying {3}{W}.",
      "Myrel has indestructible until end of turn - block her with something that would kill her and she survives.",
      ...
      "Reset. Attack with Mother of Runes alone: no trigger at all. She is a Human, and the ability says non-Human.",
      ...
      "Reset. Attack with Winota herself: she is a Human too, so she does not trigger her own ability.",
    ],
  },
  {
  ...
  },
  {
    ...
    setup:
      "A non-Gnome already out to attack with, since Anim Pakal cannot attack the turn she arrives, and a second copy already on the battlefield to carry the counters.",
    yours: [{ id: "anim-pakal-thousandth-moon" }, { id: "ragavan-nimble-pilferer" }],
    checks: [
      "Cast Anim Pakal for {1}{R}{W}: a 1/2 Human Soldier.",
      "Attack with Ragavan. The Anim Pakal that was already out gets a +1/+1 counter *first*, and then makes X Gnome tokens where X is the number of counters on her - so one Gnome, not zero.",
  ...
  },
  {
    ...
    checks: [
      ...
      "Reset. Tap it for {W} instead and cast Myrel with it: allowed, she is a Human.",
      "Reset. Try to spend the {W} on Ragavan: refused. He is a Monkey Pirate, and the mana is only for the chosen type.",
      "Cast Myrel with Cavern mana and have Salty Mike answer with Counterspell: it cannot counter her.",
  ...
  },
  {
    ...
    checks: [
      ...
      "Take Myrel: she goes to your hand.",
  ...
  },
  {
    ...
    checks: [
      ...
      "It is a Gingerbrute, not a Human - attack with it while Winota is out and check she triggers.",
    ],
  },
  {
  ...
  },
  {
    ...
    checks: [
      ...
      "Take Mother of Runes: she goes to your *hand*, not the battlefield. This is a tutor, not a reanimator.",
  ...
  },
  {
    ...
    checks: [
      ...
      "It is not a Human. Attack with it while Winota is out and check she triggers.",
    ],
  },
  {
    ...
    checks: [
      ...
      "Try to target Myrel: refused. She is legendary.",
  ...
  },
  {
    ...
    commanderInPlay: true,
    setup:
      "Winota on the battlefield, because the whole ability is a lieutenant clause and does nothing at all without her.",
    checks: [
      ...
      "The Thopter is not a Human. With Winota on the battlefield, attacking with it triggers her.",
  ...
  },
  {
    ...
    setup:
      "Another creature to protect and a red creature across the table to protect it from. Mother of Runes cannot use her ability the turn she arrives.",
    yours: [{ id: "goblin-rabblemaster" }],
    theirs: [{ id: "goblin-cratermaker" }],
    checks: [
      "Cast Mother of Runes for {W}: a 1/1 Human Cleric.",
      "Try to tap her this turn: refused, she is summoning sick. Pass a turn.",
      "Tap her targeting Goblin Rabblemaster and choose red: Salty Mike's red creature can no longer block, target or damage it.",
      "Unlike Giver of Runes, she *can* target herself - 'target creature you control' with no 'another'. Do that and check it is allowed.",
      "She offers colours only, not colourless. That is the difference between the two Runes cards and it is worth seeing side by side.",
  ...
  },
  {
    ...
    checks: [
      ...
      "Your commander counts when she is on the battlefield and not when she is in the command zone. Try both.",
    ],
  },
  {
    cardId: "mox-diamond",
  ...
  },
  {
    ...
    checks: [
      ...
      "He is a Monkey Pirate, so with Winota out he triggers her - dash plus Winota is why the card is here.",
    ],
  },
  {
    ...
    checks: [
      ...
      "Take Mother of Runes: she goes to your hand. The search is a 'may', so try declining it too.",
  ...
  },
  {
    ...
    checks: [
      ...
      "Try to target Rionya herself: refused. It says 'another target creature you control'.",
  ...
  },
  {
    ...
    checks: [
      ...
      "It is a Pest, not a Human - attack with it while Winota is out and check she triggers.",
    ],
  },
  {
    cardId: "silence",
  ...
  },
  {
    ...
    checks: [
      ...
      "They are not Humans. With Winota out, attacking with them triggers her twice.",
  ...
  },
  {
    ...
    checks: [
      ...
      "They are not Humans. With Winota out, they trigger her - two attackers, two triggers.",
    ],
  },
  {
    ...
    checks: [
      ...
      "With Winota on the board, attack with a non-Human and check her trigger is doubled too - two looks at the top six, which is what the card is here for.",
